...
try
{
    var employee1 = new SalaryEmployee { Id = 1010, Firstname = "Sandra", Lastname = "Lopez", BornDate = new Date(1980, 4, 2), HireDate = new Date(2023, 2, 12), IsActive = true, Salary = 2315544 };
    ...
    var employee4 = new BaseCommisionEmployee { Id = 4040, Firstname = "Pedro", Lastname = "Salazar", BornDate = new Date(1980, 8, 17), HireDate = new Date(2024, 11, 1), IsActive = true, CommisionPercentaje = 0.015f, Sales = 89568000, Salary = 500000 };
